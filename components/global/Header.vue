  ...
  <nav class="scrim-bg fixed z-40 top-0 inset-x-0 pt-3 px-3" aria-label="Main Menu">
    <ul class="flex">
      ...
      <li class="flex-1 ml-2">
        <nuxt-link class="btn block" to="/blog">info</nuxt-link>
      </li>
      <li class="flex-1 ml-2">
...
.nuxt-link-exact-active {
  @apply text-gray-900  bg-gray-300 bg-opacity-50 cursor-default;
}
...
.light {
  ...
  & .nuxt-link-exact-active {
    @apply text-primary-700 border-gray-600 bg-gray-300;
  }
}
